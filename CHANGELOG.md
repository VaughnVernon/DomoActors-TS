...
### Fixed
- **`package.json` license field updated**: Changed from `RPL-1.5` to `LGPL-3.0-or-later` to match the LICENSE.md and README.md changes made in 1.2.3

## [1.2.3] - 2026-04-09

### Changed
- **License changed from RPL 1.5 to LGPL 3.0**: DomoActors-TS is now distributed under the GNU Lesser General Public License v3.0 (LGPL-3.0-or-later)
- **Copyright year updated**: Copyright notices updated to 2026 across all source files
- Updated `LICENSE.md` with full LGPL 3.0 text
- Updated README.md license badge and license section
